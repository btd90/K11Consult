...
surface1FullscreenX = (monitorX / 2) - 450
surface1FullscreenY = (monitorY / 2) - 360

surface1WindowedX = (width / 2) - 450
surface1WindowedY = (height / 2) - 360

surface1X = surface1WindowedX
surface1Y = surface1WindowedY

surface2FullscreenX = (monitorX / 2) - 50
surface2FullscreenY = (monitorY / 2) - 360

surface2WindowedX = (width / 2) - 50
surface2WindowedY = (height / 2) - 360
...
surface5FullscreenX = 0
surface5FullscreenY = monitorY - 200

surface5WindowedX = 0
surface5WindowedY = height - 200
...
while True:
    ...
    #barValue=TEMP_Value
    #barValue=140
    Bars(barDestination=surface1,
        barValue=140,positionX=250,positionY=450,maximumValue=14,invert=False,
        dialType=degree,dialLabel="Temperature",units='C',backgroundColour=(0,0,81),displayPolygon=True,foregroundColour=(255,255,255))

    #TEST VALS
    #barValue=BATT_Value
    #barValue=15
    Bars(barDestination=surface2,
        barValue=15,positionX=250,positionY=450,maximumValue=1.5,invert=True,
        dialType=volt,dialLabel="Battery",units='V',backgroundColour=(0,0,81),displayPolygon=True,foregroundColour=(255,255,255))

    #TESTING
    HorizontalBars(barDestination=surface5,
        barValue=RPM_Value,positionX=10,positionY=10,maximumValue=500,doubleLine=12,singleLine=6,displayDivision=100,
        fontSize=sixty,dialLabel="RPM",displayPolygon=True,foregroundColour=(255,255,255))
